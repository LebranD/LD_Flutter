...
import 'package:first_flutter/widget/status_view.dart';
...
class _MyAccountPageState extends State<MyAccountPage> {
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      Navigator.push(context, CupertinoPageRoute(builder: (context) => MyAccountPage()));
                    },
                  ),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: StatusView(
            status: status ?? StatusViewType.normal,
